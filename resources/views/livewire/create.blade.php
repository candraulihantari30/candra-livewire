                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput2" 
                                ...
                                <input type="date" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" wire:model="tanggal" id="exampleFormControlInput2">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput3"
                                ...
                                <input type="text" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" wire:model="keterangan" id="exampleFormControlInput3">
